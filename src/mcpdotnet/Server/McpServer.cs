...
internal sealed class McpServer : McpJsonRpcEndpoint, IMcpServer
{
    ...
    private void SetResourcesHandler(McpServerOptions options)
    {
        ...
        {
            throw new McpServerException("Resources capability was enabled, but ListResources and/or ReadResource and/or ListResourceTemplates handlers were not specified.");
        }
